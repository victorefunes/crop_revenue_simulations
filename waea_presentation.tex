...
\begin{frame}{Research questions}
    \begin{wideitemize}
        \item \textcolor{red}{\textbf{Question 1}}: Does a more complex rotation improve financial outcomes, or do agronomic gains hit diminishing returns versus simple alternation?
        \item \textcolor{red}{\textbf{Question 2}}: What is the 6-year delinquency probability, conditioning yields on the full six-year rotation history of the field?
        \item \textcolor{red}{\textbf{Question 3}}: How does the negative price–yield correlation change those probabilities, and does it substitute for or complement rotation?
        \item Current credit-risk models don't see a problem because they treat revenue as one aggregate stream and predict default from one-year loss probabilities.
    \end{wideitemize}
\end{frame}
...
\begin{block}{Farm credit risk: Farm survival and exit decisions}
    \begin{itemize}
        \item \textit{Key Papers}: \cite{Featherstone1988, Ifft2015, Kim2020}
...
\begin{column}{.35\textwidth}
  \begin{wideitemize}
  \item $\approx 55\%$: Corn monoculture (central/high)
  \item $\approx 30\%$: Perfect rotation (same cell)
...
\begin{frame}{Soy years reset the debt cycle — the sawtooth}
\begin{columns}[T] % align columns
\begin{column}{.65\textwidth}
\resizebox{\textwidth}{!}{
...
\begin{block}{Three things to remember}
    \begin{enumerate}
        \item \textcolor{razorbackred}{Rotation reduces delinquency through a debt-reset channel}.
        
        The mechanism is the soy-year sawtooth, not yield smoothing.
        \item \textcolor{springwater}{Price dominates revenue variance — but rotation is what does the work}.

        Hedge and rotation are partial substitutes; rotation is the cheaper, more reliable instrument.
