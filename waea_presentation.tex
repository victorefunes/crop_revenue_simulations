...
\begin{frame}{Research questions}
    \begin{wideitemize}
        ...
        \item \textbf{Sustainable practices}: Crop rotation reduces yield variance, severs the debt-rollover chain, and lowers multi-year delinquency risk. It is the link between agronomic sustainability and financial resilience.
    \end{wideitemize}
\end{frame}
