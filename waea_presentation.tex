...
\begin{frame}{Motivation}
    ...
    \small
    \begin{itemize}
    \item \textcolor{cardinalred}{2015-16} \textbf{Commodity price collapse}: Corn falls from \$7 $\rightarro$ \$3.50/bu. Farm income drops 45\% in 3 years. Operating-loan stress builds.
...
\begin{frame}{Research questions}
    \begin{wideitemize}
        ...
        \item \textcolor{red}{\textbf{Question 2}}: What is the 6-year delinquency probability, conditioning on yields on the full six-year rotation history of the field?
        ...
        \item If revenue is treated as one aggregate stream and default is predicted from one-year loss probabilities, these issues are not accounted for.
    \end{wideitemize}
\end{frame}
